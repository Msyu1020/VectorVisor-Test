...
fn main() {
    ...
    let matches = App::new("vectorvisor")
        ...
        .arg(Arg::with_name("jitcache")
            ...
            .number_of_values(1)
            .takes_value(true))
 	.arg(Arg::with_name("volatile")
            .long("volatile")
            .value_name("Flag to force all reads/writes to ignore GPU cache (only for benchmarking)")
            .default_value("false")
            .help("This flag forces reads/writes to be volatile")
            .multiple(false)
            .number_of_values(1)
            .takes_value(true))
        ...
        .arg(Arg::with_name("localworkgroup")
            ...
            .default_value("999999") // 999999 is the fake default val, we just let OpenCL auto-determine in this case
            ...
            .map(|idx| {
                ...
                */
                ...
                for _ in 0..num_vms.clone() {
                    ...
                    vm_sender_vec.push((Mutex::new(sender1), Mutex::new(sender2)));
                    server_recv_vec.push((AsyncMutex::new(recv1), AsyncMutex::new(recv2)));
                }
