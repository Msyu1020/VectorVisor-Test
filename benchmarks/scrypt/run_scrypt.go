...
func RandStringVec(n int, num_items int) []string {
	b := make([]string, num_items)
	for i := range b {
		b[i] = RandString(n)
	}
	return b
...
func main() {
	...
	ch_exec_time := make(chan float64, 100000000)
	ch_latency := make(chan float64, 100000000)
	ch_queue_time := make(chan float64, 100000000)
	ch_submit := make(chan float64, 100000000)
	ch_unique_fns := make(chan float64, 100000000)
	ch_req_queue_time := make(chan float64, 100000000)
	ch_device_time := make(chan float64, 100000000)
	ch_overhead := make(chan float64, 100000000)
	ch_compile := make(chan float64, 100000000)
